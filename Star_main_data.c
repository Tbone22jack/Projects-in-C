...
#include <math.h>
#include <string.h>
// this allows me to append numbers as chars in a string
char *
...
void fourth_order_RungeKutta_2(double I_A, double I_M, double I_S,double delta_t,int iteration);
...
int main() {
	...
	fourth_order_RungeKutta_2(A_cloud, M_cloud, S_active, delta_t,iteration);
	return 1;
}
...
void fourth_order_RungeKutta_2(double I_A, double I_M, double I_S,double delta_t,int num) {
	double S_active = I_S, M_cloud = I_M, A_cloud = I_A, SS_active, SM_cloud,
